...
//        Assertions.assertEquals("test-object-string-early", value, "Should have early value");
//
...
//        Assertions.assertAll(() -> Assertions.assertEquals("first-value", tdTree.getValue(TEMPORAL_TEST_ID, 4)),
//                () -> Assertions.assertEquals("second-value", tdTree.getValue(TEMPORAL_TEST_ID, 5)),
//                () -> Assertions.assertEquals("third-value", tdTree.getValue(TEMPORAL_TEST_ID, 9)));
//
////        Try for some deletions
//        tdTree.deleteValue("test-object", 2);
//        Assertions.assertNull(tdTree.getValue("test-object", 2), "Should have null value");
//        Assertions.assertEquals("test-object-string4", tdTree.getValue("test-object4", 1), "Shouldn't throw an error after deleting a key/value pair");
//
////        Try to update values and temporals
//        tdTree.updateValue(TEMPORAL_TEST_ID, 5, "new-value");
//        Assertions.assertEquals("new-value", tdTree.getValue(TEMPORAL_TEST_ID, 5));
//        tdTree.setKeyTemporals(TEMPORAL_TEST_ID, 6, 6, 8);
//        Assertions.assertAll(() -> Assertions.assertNull(tdTree.getValue(TEMPORAL_TEST_ID, 10), "Should not have any value valid at time 10"),
//                () -> Assertions.assertEquals("third-value", tdTree.getValue(TEMPORAL_TEST_ID, 7)));
//        tdTree.replaceKeyValue(TEMPORAL_TEST_ID, 3, 3, 4, "updated-temporal-value");
//        Assertions.assertAll(() -> Assertions.assertEquals("updated-temporal-value", tdTree.getValue(TEMPORAL_TEST_ID, 3)),
//                () -> Assertions.assertNull(tdTree.getValue(TEMPORAL_TEST_ID, 1)));
//
////        Try to remove a key and see if it returns a null
//        tdTree.deleteKeysWithValue("test-object-string2");
//        Assertions.assertNull(tdTree.getValue("test-object2", 7));
//    }
//
//    @Test
