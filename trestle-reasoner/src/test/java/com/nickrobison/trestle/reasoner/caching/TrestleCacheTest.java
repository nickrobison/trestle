...
//        final TestClasses.OffsetDateTimeTest offsetDateTimeTest = new TestClasses.OffsetDateTimeTest(5515, OffsetDateTime.now(), OffsetDateTime.now().plusYears(5));
        ...
        TestClasses.JTSGeometryTest first = reasoner.readTrestleObject(TestClasses.JTSGeometryTest.class, jtsGeometryTest.getId().toString(), LocalDate.of(1989, 7, 1), null);
        ...
        TestClasses.JTSGeometryTest second = reasoner.readTrestleObject(TestClasses.JTSGeometryTest.class, jtsGeometryTest.getId().toString(), LocalDate.of(1990, 3, 1), null);
...
//        Update one of the facts, which should invalidate the cache
        ...
        reasoner.addFactToTrestleObject(TestClasses.JTSGeometryTest.class, jtsGeometryTest.getId().toString(), "geom", jtsGeom2, LocalDate.of(1989, 10, 1), null, null);
        reasoner.getUnderlyingOntology().runInference();
        firstStart = Instant.now();
        first = reasoner.readTrestleObject(TestClasses.JTSGeometryTest.class, jtsGeometryTest.getId().toString(), LocalDate.of(1989, 10, 20), null);
        ...
        second = reasoner.readTrestleObject(TestClasses.JTSGeometryTest.class, jtsGeometryTest.getId().toString(), LocalDate.of(1990, 3, 1), null);
