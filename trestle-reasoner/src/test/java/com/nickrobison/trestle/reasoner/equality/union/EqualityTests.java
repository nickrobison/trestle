...
//        2014 -> 2013
        ...
        final List<OWLNamedIndividual> obj78EqObjectsEmpty = ((EqualityEngineImpl) this.reasoner.getEqualityEngine()).getEquivalentObjects(EqualityTestClass.class, obj7Individual, LocalDate.of(2013, 3, 11));
...
//        Check for objects that have invalid temporal directions
        assertThrows(IllegalStateException.class, () -> ((EqualityEngineImpl) this.reasoner.getEqualityEngine()).getEquivalentObjects(EqualityTestClass.class, Arrays.asList(obj2Individual, obj9Individual), LocalDate.of(2014, 3, 11)));
    }
