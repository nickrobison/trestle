...
public class QueryBuilderTest {
    ...
    private static final String relationString = "BASE <http://nickrobison.com/dissertation/trestle.owl#>\n" +
            "TRESTLE_PREFIX : <http://nickrobison.com/dissertation/trestle.owl#>\n" +
            "TRESTLE_PREFIX trestle: <http://nickrobison.com/dissertation/trestle.owl#>\n" +
            "TRESTLE_PREFIX owl: <http://www.w3.org/2002/07/owl#>\n" +
            "TRESTLE_PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>\n" +
            "TRESTLE_PREFIX xml: <http://www.w3.org/XML/1998/namespace>\n" +
            "TRESTLE_PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>\n" +
            "TRESTLE_PREFIX ogc: <http://www.opengis.net/ont/geosparql#>\n" +
            "TRESTLE_PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>\n" +
            "TRESTLE_PREFIX ogcf: <http://www.opengis.net/def/function/geosparql/>\n" +
    ...
    private static final String oracleSpatialString = "BASE <http://nickrobison.com/dissertation/trestle.owl#>\n" +
            ...
            "TRESTLE_PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>\n" +
            "TRESTLE_PREFIX xml: <http://www.w3.org/XML/1998/namespace>\n" +
            "TRESTLE_PREFIX ORACLE_SEM_HT_NS: <http://oracle.com/semtech#leading(?wkt)>\n" +
            "TRESTLE_PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>\n" +
            "TRESTLE_PREFIX ogc: <http://www.opengis.net/ont/geosparql#>\n" +
            "TRESTLE_PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>\n" +
            "TRESTLE_PREFIX ogcf: <http://www.opengis.net/def/function/geosparql/>\n" +
