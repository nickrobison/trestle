...
declare namespace mapboxgl {
    ...
    export class Map extends Evented {
        ...
        queryRenderedFeatures(pointOrBox?: mapboxgl.Point|number[]|mapboxgl.Point[]|number[][], parameters?: {layers?: string[], filter?: any[]}): LayerQueryResult[];
    ...
    export interface LayerQueryResult extends GeoJSON.Feature<GeoJSON.GeometryObject> {
        layer: Layer;
    }
