...
import com.nickrobison.spatialdifference.storm.utils.KryoFactory;
...
//        Check that the attributes are fine
        assertEquals(CODEVALUE, deserializedPolygon.attributes.get(CODE));
        assertEquals(NAMEValue, deserializedPolygon.attributes.get(NAME));
        assertEquals(inputPolygon.polygon.calculateArea2D(), deserializedPolygon.polygon.calculateArea2D(), 0.0);
...
//        Deserialize
        ...
        assertEquals(newWritableEnvelope.polygon.calculateArea2D(), deserializedPolygon.polygon.calculateArea2D(), 0.0);
